...
void createColorPass(Vulkan *vulkan)
{
    ...
    CheckResult(vkCreateRenderPass(vulkan->device, &renderPassInfo, nullptr, &vulkan->colorPass));
}
...
void createShadowPass(Vulkan *vulkan)
{
    ...
    std::vector<VkAttachmentDescription> attachments = {shadowAttachment, depthAttachment};
    ...
    CheckResult(vkCreateRenderPass(vulkan->device, &renderPassInfo, nullptr, &vulkan->shadowPass));
}
} // namespace tat