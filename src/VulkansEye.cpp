...
void VulkansEye::init(uint32_t width, uint32_t height) {
  ...
  vulkan.window = glfwCreateWindow(vulkan.width, vulkan.height, "Vulkans Eye",
                                   nullptr, nullptr);
  ...
  player.setPerspective(config.playerConfig.fieldOfView,
                        static_cast<double>(vulkan.width),
